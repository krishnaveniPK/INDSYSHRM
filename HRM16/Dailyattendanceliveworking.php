  ...
  if($Regsisterattendence ==1)
{
  ...
  else
  {
    ...
    values('$Clientid','$Employeeid','$AttendanceDate','$Title','$Firstname','$Lastname','$user_id','$date','$Workingdays','00:00:00','$Intime','$Outtime','08:00','$AttenStatus','00:00:00','N','$Indate','$Outdate','$Department','$Designation','00:00:00','00:00:00',0,0,0)";
...
try
{
    ...
    $Manualattendence = 1;   
    Calculateouttimefetch($conn,$Clientid,$Employeeid,$Attendencedate,$AttenStatus,$Intime,$Outtime,$Permissionyesorno,$Manualattendence);
//    $Workingdays=0;
...
function Calculateouttimefetch($conn,$Clientid,$Employeeid,$Attendencedate,$AttenStatus,$Intime,$Outtime,$Permissionyesorno,$Manualattendence)
{
  try
  {
       $Workingdays=0;
