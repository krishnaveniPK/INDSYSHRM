...
<head>
    ...
    <title>Payslip Details-Category wise</title>
</head>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">Category wise - Payslip details</h3>
								...
								<form role="form" action="payslip_monthwise.php" method="post" target="_blank">
