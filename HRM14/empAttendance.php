<?php
function get_attendance($conn,$emp_id,$periods,$date_of_joining){
	...
	$logsql = "SELECT * FROM vwattendenceclosestatus WHERE Employeeid  = '".$emp_id."' AND DATE(Attendencedate) >= '".$month_date."' AND DATE(Attendencedate) <= '".$last_date."'  and Empattendencestatus='Close' ORDER BY Attendencedate ASC";
	//echo $logsql;
