        ...
        <div class="dashboard-wrapper" ng-App="MyApp" ng-controller="HRM14Controller">
            <div class="container-fluid dashboard-content">
                                    ...
                                    <div class="" style="padding:25px 0 10px 25px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:100px">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ng-model="Status" autocomplete="off">
                                        ...
                                        <div class="float-right mt-2" style="margin-right: 15px;">
                                            ...
                                            <button class="btn btn-sm btn-brand" ng-click="UpdateStatus();"
                                                ng-disabled="btnEmployee">Close Payroll</button>
                ...
                <td>{{e.Salyear}}</td> -->
                                                            ...
                                                            <td>{{e.Workingdays}}</td>
                                                            <td> <input class="form-control" readonly ng-model=e.Workeddays
                                                            ...
                                                            <td> <input class="form-control" readonly ng-model=e.Leavedays
                                                                    onkeypress="return Validate(event);"
                                                                    ng-model-options='{ debounce: 2000 }'
                                                                    ng-change="Getcalvalue(e.Employeeid,e.SalMonth,e.Salyear,e.Workeddays,e.Leavedays,e.Salary_Advance,e.FoodDeduction,e.TDS,e.Category,e.Workingdays,e.Nationalholidays,e.CL,e.BasicDA,e.HRA,e.Otherallowance_Con_SA,e.DailyAllowanance,e.OT_HRS,$index,e.Performanceallowance)" />
                                                            </td>
                                                    ...
                                                    <tr style='background-color:yellow'
                                                        ...
                                                        <td colspan="35" style="text-align:right">Total</td>
                                                        <!-- <td>{{NetWages}}</td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="table-responsive custom-table custom-table-noborder ">
                                                <table class="table table-bordered  table-sm table-striped">
                                                    ...
                                                    <tr style='background-color:yellow'
                                                        ng-show="Category=='Category 3'">
                                                        <td colspan="35" style="text-align:right;font-weight:bold">Total&nbsp;&nbsp;</td>
                                                        <!-- <td>{{NetWages}}</td>
                                                        <td>{{Performanceallowance}}</td> -->
                                                    ...
                                                    <tr style='background-color:yellow'
                                                        ng-show="Category!='Category 3'">
                                                        <td colspan="33" style="text-align:right;font-weight:bold">Total&nbsp;&nbsp;</td>
                                                        <!-- <td>{{NetWages}}</td>
                                                        <td>{{Performanceallowance}}</td> -->
                                                        <td style="text-align:right;font-weight:bold">{{GrandTotal}}</td>
                                                    </tr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="table-responsive custom-table custom-table-noborder ">
                                                ...
                                                <table class="table table-bordered  table-sm table-striped"
                                                    ...
                                                    <tr style='background-color:yellow'>
                                                        <td colspan="32" style="text-align:right">Total</td>
