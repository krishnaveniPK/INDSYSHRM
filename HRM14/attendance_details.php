                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">Attendance Form</h3>
								...
								<form role="form" action="attendance_detailsLIST.php" method="post" target="_blank">
                                        ...
                                        <td class="col-md-8">
                                         <label>Category</label>
                                          <div class="select-check">  
											...
											<select id="multiple-checkboxes" multiple="multiple" name="catname[]" ng-model="catname" class="form-control multiple-checkboxes"  style="width:250px">	
...
$(document).ready(function() {
    $('#multiple-checkboxes').multiselect('select', ['Category 1', 'Category 2', 'Category 3'])({
