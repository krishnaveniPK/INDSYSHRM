...
try
{
    ...
    CallEmppdatepayroll($conn,$Clientid,$user_id,$date, $Employeeid,$SalMonth, $Salyear,$Workeddays, $Leavedays,$Salary_Advance, $FoodDeduction,$TDS,$Category,$Workingdays,$Nationalholidays, $CL, $BasicDA,$HRA,$Otherallowance_Con_SA , $OT_HRS, $DailyAllowanance,$Performanceallowance,$Dormitory,$Transport);
...
$abs_diff=$abs_diff+1;
    if($dateofjoingdays<=$abs_diff)
    {
      ...
      $sqlHDND = "SELECT Count(*) as total from vwholidaymaster where Monthname ='$month_num' and Year = '$Payrollyear' and Dayname!='Sunday' AND Clientid ='$Clientid'  AND DATE(Holidaydate) <='$date_of_joining'";
