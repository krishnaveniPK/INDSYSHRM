...
<head>
    ...
    <title>Present Attendence Details </title>
</head>
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper" ng-App="MyApp" ng-controller="HRM19Controller">
            <div class="container-fluid dashboard-content">
                <div class="row col-lg-12">
                <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">Present Details</h5>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <button class="btn btn-sm btn-success" 
                                        ...
                                        <a class="btn btn-warning btn-sm" href="PresentExcel.php"
    ...
    <script src="../Scripts/Controller/HRM19Controller.js"></script>
