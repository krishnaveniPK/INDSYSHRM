...
$gettime = "Present Details_$Attendencedate.xls";
...
$GetState = "SELECT * FROM indsys1030empdailyattendancedetail where Attendencedate='$Attendencedate' AND Attentypestatus='P' 
