            ...
            <div class="">
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" ng-model="DVoucherno" autocomplete="off" readonly>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control" ng-model="ReceiverType" ng-change="GetReceivertype(ReceiverType);" >
                    ...
                    <div class="form-group col-md-3" ng-show="btninternal">
                        ...
                        <select ng-model="Employeeid" class="form-control"
                                        ng-change="FetchReceivername(Employeeid)">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control" ng-model="DVAmount" autocomplete="off"  ng-model-options='{ debounce: 1000 }'
                                                ng-change="CheckInwardAmount(DVAmount)">
                            </div>
