                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h5 class="text-green">View Voucher</h5>
                                <hr />
                                ...
                                <div class="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" ng-model="DVStatus"
                                                autocomplete="off" readonly>
                                                        ...
                                                        <div class='settlement-data'>
                                                            ...
                                                            <table class=''>
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td><img class='settlement-logo'
                                                                                src='sainmarks.png'>
                                                                            <center style="margin-left:80px">
                                                                                <b>SAINMARKS
                                                                                    INDUSTRIES INDIA PVT
                                                                                    LTD</b><br /> 476/1b1a,label Arcade,
                                                                                Jothi
                                                                                Nagar, Palavanjipalayam, Dharapuram
                                                                                Road,<br />
                                                                                KNP Colony (P.o), Tirupur – 641 605,
                                                                                India
                                                                            </center>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan='2'><b>Date</b>:{{DVoucherdate2}}
                                                                        </td>
                                                                    </tr>
