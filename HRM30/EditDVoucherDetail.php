                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <select ng-model="Chartofaccount" class="form-control">
                                                    <option ng-repeat="s in GetChartOfAccountList "
                                                        value="{{s.Chartofaccount}}">
                                            ...
                                            <div class=" col-md-12 text-right">
                                                <div class="form-btn-sm form-btn-top">
                                                    <button class="btn btn-success"
                                                        ng-click="UpdateVoucherNo();">Save</button>
                                                    <button class="btn btn-warning" ng-click="ResetDetail();">Add
                                                        Details</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-7">
                                                    ...
                                                    <form method="POST" class="camara-form" action="storeImage.php"
                                                        ...
                                                        <div class="row mt-3" ng-show="btncamera">
                                                            <div class="col-lg-12">
                                                                <div class="card">
                                                                    ...
                                                                    <button type="button" data-target="#myCarousel"
                                                                        data-slide-to="0" class="btn btn-back btn-sm">
