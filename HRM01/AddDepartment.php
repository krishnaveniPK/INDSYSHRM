...
<head>
    ...
    <title>Department List | HRM Dashboard</title>
</head>
...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper" ng-App="MyApp" ng-controller="HRM01Controller">
            <div class="container-fluid dashboard-content">
                        ...
                        <div class="row">
                            ...
                            <input id="inputText3" type="text" class="form-control" ng-model="Department" placeholder="Enter Department Name" ng-change="GetDepartment();" autocomplete="off">
                            </div>
                            <div class="form-btn-sm">&nbsp;
                            <button class="btn btn-success"
                            ng-click="SaveDepartment();">Save <i class="fa fa-plus"></i></button>
                            ...
                            <div class="col-md-12">
                                        ...
                                        <table class="table table-bordered  table-sm info-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr dir-paginate="e in GetDepartmentList |filter:searchDepartment|itemsPerPage:n "
                                                   ...
                                                   <center> <img height="15" data-toggle="modal"
                                                            ...
                                                            ng-click="SendEdit(e.Department);" src="<?php echo "$domain"; ?>/assets/icons/delete.png">
                                                            </center>
                                                        </div>
                                                    </td>
                                                </tr>
    ...
    <script src="../Scripts/Controller/HRM01Controller.js"></script>
</body>
