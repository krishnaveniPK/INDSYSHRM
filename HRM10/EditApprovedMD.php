...
$Approvedstatus = $_POST["Approvedstatus"];
  ...
  $CandidateMDAprroveQry = "Update indsys1020employeeeditingrights set  MD_Approval_Time ='$date',  MD_Approval_Status='$Approvedstatus', Addormodifydatetime ='$date'
  WHERE Employeeid = '$Employeeid' and Sno ='$Sno' AND Clientid ='$Clientid' ";  
  $resultCandidateMDAprroveQry = $conn->query($CandidateMDAprroveQry);

    if($Approvedstatus =="Approved")
    {
      
    $GetChapter = "SELECT * FROM indsys1020employeeeditingrights where  Employeeid = '$Employeeid' and Sno='$Sno' AND Clientid ='$Clientid' ORDER BY Employeeid";
   ...
   // echo "Mail Send Successfully";
    ...
    header("Location: $domain/HRM10/TYPage.php");
