...
$gettime = "Cat-3 Present Details_$Attendencedate.xls";
...
$active->setTitle("CAT-3 PresentDetails");
...
$active->setCellValue('A2',"Cat-3 PresentDetails For $Attendencedate");
...
AND Attentypestatus='P' AND Clientid = '$Clientid' ORDER BY Employeeid";
