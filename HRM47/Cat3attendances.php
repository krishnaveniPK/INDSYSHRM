...
<head>
    ...
    <title>Cat-3 Present Attendence Details </title>
</head>
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper" ng-App="MyApp" ng-controller="HRM47Controller">
            <div class="container-fluid dashboard-content">
                <div class="row col-lg-12">
                <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">Category-3 Present Attendances Details</h5>
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" class="form-control" ng-model="AttendanceDate"
                                        ...
                                        ng-change="Getcat3pAttendanceDate();"
                                      >
                                </div>
                                <!--  -->
                                <div class="form-group text-right mt-25">
                                <button class="btn btn-sm btn-success" 
                                        ng-click="Getcat3pAttendanceDate();">Get Details</button> 
                                        <a class="btn btn-warning btn-sm" href="Cat3presentexcel.php"
    ...
    <script src="../Scripts/Controller/HRM47Controller.js"></script>
