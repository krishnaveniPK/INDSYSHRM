...
<head>
    ...
    <title>Absent Attendence Details </title>
</head>
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper" ng-App="MyApp" ng-controller="HRM20Controller">
            <div class="container-fluid dashboard-content">
                <div class="row col-lg-12">
                <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">Absent Details</h5>
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-2">
                                    <label class="col-form-label">Attendance Date</label>
                                    <input type="text" class="form-control" ng-model="AttendanceDate"
                                        onfocus="(this.type='date')" onblur="(this.type='date')"  ng-model-options='{ debounce: 1500 }'  ng-change="GetAttendanceDate();"
                                      >
                                </div>
                                <!--  -->
                                <div class="form-group text-right mt-25">
                                <button class="btn btn-sm btn-success" 
                                        ng-click="GetAttendanceDate();">Get Details</button> 
                                        <a class="btn btn-warning btn-sm" href="AbsenttExcel.php"
                    ...
                    <div class="card">
                        <h5 class="card-header text-green">Employee Absent  Details</h5>
                        <div class="card-body">
                            <div id="pdfExport" >
                            <table class="table table-bordered" style="width:100%">
                                <thead>
                                    <tr class="bg-green text-white">
                                        ...
                                        <th scope="col">OT-Intime</th>
                                        <th scope="col">OT-Outtime</th>
                                ...
                                <tr>
                                    ...
                                    <tr dir-paginate="e in GetEmpDailyAttendanceList|filter:searchHoliday |itemsPerPage:n"
    ...
    <script src="../Scripts/Controller/HRM20Controller.js"></script>
