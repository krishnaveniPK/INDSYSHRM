                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="card-body">
                                                    ...
                                                    <input type="file" class="form-control" ng-model="clearinput" id="fileInputBulkEmpSalary"
                                                        name=files[]
                                         ...
                                         <div class="form-group col-md-4">
                                                    ...
                                                    <div class="mt-25">
                                                        <button class="btn btn-sm btn-success" id="fileButtonEmp01"><i class="fa fa-table"></i>
                                                            Upload
                                                        </button>
