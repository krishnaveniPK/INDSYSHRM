...
$gettime = "Cat-3 Absent Details_$Attendencedate.xls";
...
$active->setTitle("CAT-3 AbsentDetails");
...
$active->setCellValue('A2',"Cat-3 AbsentDetails For $Attendencedate");
...
AND Attentypestatus='A' AND Clientid = '$Clientid' ORDER BY Employeeid";
