...
if (isset($_FILES['files']) && !empty($_FILES['files'])) {
    ...
    $directory = "../EMPHANDITEM/$Employeeid/$Sno/";
...
$Propertychecklistitemimage = $directory . $uniquesavename;
...
$resultExists01 = $conn->query($resultExists);
  ...
  {
    $sqlsave = "INSERT IGNORE INTO indsys1034handoveritems (Clientid,Employeeid,Sno,Particulars,Userid,Addormodifydatetime,Qtyitem,Distributeddate,Handoverdate, Notes, StoredPlace,ConcernName,Propertychecklistitemimage)
    VALUES ('$Clientid','$Employeeid','$HandoveritemNextno','$Particulars','$user_id','$date','$Qtyitem','$Distributeddate','$Handoverdate','$Notes','$StoredPlace','$ConcernName','$Propertychecklistitemimage')";
