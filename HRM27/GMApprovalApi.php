            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-6 ">
                    <div class="text-right"> <button class="btn btn-sm btn-rounded btn-danger"
                            ng-click="UpdatedGMRejected()"><i class="fa fa-times" aria-hidden="true"></i>
                            Reject</button>
                        <button class="btn btn-sm btn-rounded btn-success" ng-click="UpdateGMApproved()"><i
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a class="btn btn-rounded btn-success" ng-click="SendMAILGM_Approve();"
