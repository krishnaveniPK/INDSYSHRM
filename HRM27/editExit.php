                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="container-fluid dashboard-content">
                                ...
                                <div class="card">
                                    <h5 class="card-header text-green">Exit Employee
                                        Requesting Details
                                    </h5>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered  table-sm table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr dir-paginate="e in GetEmployeeListedit |filter:searchEmployee|itemsPerPage:10"
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ng-model="EmpDesignation" autocomplete="off" readonly>
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label class="col-form-label">Approval
                                                            Status</label>
                                                        <input type="text" class="form-control"
                                                            ng-model="Approvalstatus" autocomplete="off" readonly>
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                    ...
                                                    <div class="text-right col-md-12">
                                                        <button class="btn btn-sm btn-success"
                                                            ng-click="SaveExit();" ng-show="btnsave"><i
                                                                class="fa fa-save"></i>Update</button>
                                                        <!-- <button class="btn btn-rounded btn-success"
                                                            ng-click="Sendmail();"><i class="fa fa-envelope"></i>
                                                            Emailsend</button> -->
                                                        <button class="btn btn-sm btn-success"
                                                            ng-click="FetcheditEmployee(Employeeid);"><i
                                                                class="fa fa-circle-notch"></i> Refresh</button>
                                                        <button class="btn btn-sm btn-danger" 
                                                            ng-show="Exitstatus=='Approved'"
                                                            ng-click="DeactiveMessage();"><i class="fa fa-times"></i>Exit
                                                        </button>
                                        ...
                                        <table class="table table-bordered  table-sm ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control" ng-model="ADMIN_Notes"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="pdfExport">
                                            ...
                                            <h1 style="color:green;font-size: 26px;"> SAINMARKS INDUSTRIES INDIA
                                                PVT LTD, TIRUPUR</h1>
                                            ...
                                            <br /><br />
                                            <p><b>4. Describe what you disliked while working with Company
                                                    Name.</b></p>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td colspan='3'>
                                                                ...
                                                                <center><b>SAINMARKS INDUSTRIES INDIA PVT LTD</b><br />
                                                                    476/1B1A,LABEL ARCADE, JOTHI NAGAR,
                                                                    PALAVANJIPALAYAM, DHARAPURAM MAIN ROAD,<br />
                                                                    TIRUPUR – 641 608, TAMILNADU, INDIA. TP - 17460
                                                                </center>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="nodueExport">
                                            ...
                                            <body>
                                                ...
                                                <h1 style="color:green;font-size: 26px;"> SAINMARKS INDUSTRIES INDIA
                                                    PVT LTD, TIRUPUR</h1>
                                                <h2 style="color:green;font-size: 20px;">No Dues Certificate</h2>
                                                ...
                                                <table class='w-100'>
                                                    ...
                                                    <tr>
                                                        <td style="min-width:25%">Employee Signature</td>
                                                        <td style="min-width:25%">HOD Signature</td>
                                                        <td style="min-width:25%">HR & Admin.Signature</td>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <iframe ng-src="{{HandoveritemView}}"
                                        ...
                                        ng-show="HandoveritemView != null " style="height:400px;width:100%"></iframe>
                                </div>
                                <div class="row">
                                    ...
                                    <iframe ng-src="{{HandoveritemView2}}"
                                        ...
                                        ng-show="HandoveritemView2 != null " style="height:400px;width:100%"></iframe>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-rounded btn-dark"
