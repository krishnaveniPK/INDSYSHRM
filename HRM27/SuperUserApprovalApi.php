...
<head>
    ...
    <title>Super User Approved</title>
...
<body>
    <div class="dashboard-wrapper" ng-App="MyApp" ng-controller="HRMEXITAPIController">
        <div class="container ">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-12 mx-15">
                            <label class="col-form-label">
                                GM Notes</label>
                            <textarea type="text" class="form-control " ng-model="GM_Notes"
                                autocomplete="off" readonly></textarea>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-12 mx-15">
                            <label class="col-form-label">
                                Admin Notes</label>
                            <textarea type="text" class="form-control " ng-model="ADMIN_Notes"
                                autocomplete="off"></textarea>
                        </div>
                    </div>
            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-6 ">
                    <div class="text-right"> <button class="btn btn-sm btn-rounded btn-danger"
                            ng-click="UpdatedSuperUserRejected()"><i class="fa fa-times" aria-hidden="true"></i>
                            Reject</button>
                        <button class="btn btn-sm btn-rounded btn-success" ng-click="UpdateSuperUserApproved()"><i
            ...
            <div class="modal fade" id="ModalAdminMail" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="alert alert-danger" role="alert">
                               Do You Want To Send Mail For Approval To Super User?
                            </div>

                        </div>
                        <div class="modal-footer">
                            <a class="btn btn-rounded btn-success" ng-click="SendMAILSUPERUSER_Approve();"
