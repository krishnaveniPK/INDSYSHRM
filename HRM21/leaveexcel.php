...
$gettime = " Leave Details_$Attendencedate.xls";
...
$active->setCellValue('A2'," Leave Details For $Attendencedate");
...
$active->setCellValue('F3','OTIntime');
$active->setCellValue('G3','OTOuttime');
$active->setCellValue('H3','Workinghours');
$active->setCellValue('I3','OT_HRS');



$GetState = "SELECT * FROM indsys1030empdailyattendancedetail where Attendencedate='$Attendencedate' AND Attentypestatus='L' 
...
$currentContenRow=4;
  ...
  while($row = mysqli_fetch_array($result_Region)) {  
    ...
    $active->setCellValue('F'.$currentContenRow,$row['OTIntime']);
    $active->setCellValue('G'.$currentContenRow,$row['OTOuttime']);
    $active->setCellValue('H'.$currentContenRow,$row['Workinghours']);
    $active->setCellValue('I'.$currentContenRow,$row['OT_HRS']); 
