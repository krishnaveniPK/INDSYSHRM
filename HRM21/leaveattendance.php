...
<head>
    ...
    <title> Leave Attendence Details </title>
</head>
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper" ng-App="MyApp" ng-controller="HRM21Controller">
            <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <button class="btn btn-sm btn-success" 
                                        ...
                                        <a class="btn btn-warning btn-sm" href="leaveexcel.php"
                    ...
                    <div class="card">
                        <h5 class="card-header text-green">Employee Leave Attendance  Detail</h5>
                        <div class="card-body">
                            <div id="pdfExport" >
    ...
    <script src="../Scripts/Controller/HRM21Controller.js"></script>
