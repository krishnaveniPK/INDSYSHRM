...
<head>
    ...
    <title>General Manager Approval</title>
    <style type="text/css">
        .cardapi{
            font-size: 14px;
            padding: 15px;
        ...
        .cardapi input{font-size: 14px;padding: 3px;}

        .cardapi .card-header{color: #008000;background-color: #ffffff;}
        .dashboard-wrapper{margin-top: 25px;}
        .cardlabel .col-form-label{padding-bottom: 0px;}
        .mb-0{margin-bottom: 0px !important;}
        .mx-15{margin: 0 -15px;}
        .thead-1{background-color: #349734;color: #ffffff;}
        .thead-2{background-color: #1c511c;color: #ffffff;}
        .thead-2 th{font-weight: normal !important;}
        .can-table{margin-top: 10px;}
        .fit-table-new{max-width: 800px;font-size: 13px;}
        .fit-table-new input{font-size: 14px;padding: 3px;}
        .table-head{color: #008000;}
...
<body>
    <div class="dashboard-wrapper" ng-App="MyApp" ng-controller="HRMApiController">
        <div class="container">
                        ...
                        <div class="row mb-0">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group "><span class="input-group-prepend">
                                        ...
                                        <input type="text" style="width:30%" placeholder="Firstname" class="form-control" ng-model="Title"
                                            readonly>&nbsp;
            ...
            <div class="card cardapi cardlabel">
                <h5 class="card-header text-green pl-0">
                    Deptertment Head Interview Notes</h5>
                <div class="card-body">

                    <div class="row">
                        <div class="form-group col-md-12 mx-15">
                            <label class="col-form-label">
                                Deptertment Head Interview Notes</label>
            ...
            <div class="card cardapi cardlabel">
                <h5 class="card-header text-green pl-0">
                    General Manager Interview Notes</h5>
                <div class="card-body">

                    <div class="row">
                        <div class="form-group col-md-12 mx-15">
                            <label class="col-form-label">
                                General Manager Interview Notes</label>
            ...
            <div class="card cardapi cardlabel">
                <h5 class="card-header text-green pl-0">
                    Admin Interview Notes</h5>
                <div class="card-body">

                    <div class="row">
                        <div class="form-group col-md-12 mx-15">
                            <label class="col-form-label">
                               Admin Interview Notes</label>
 ...
 <table class="table table-bordered  table-sm info-table can-table">
                ...
                <h4 class="card-header text-green pl-0">{{FitType}}</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-1 nopadding">
                            <input type="text" class="form-control" ng-model="CurAnnuaSpecialAllowance" readonly>
                        </div>
                        <div class="col-lg-1 nopadding">
                            <input type="text" class="form-control" ng-model="CurincperSpecialAllowance" readonly>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-1 nopadding">
                            <input type="text" class="form-control" ng-model="CurincperEstimatedBonous" readonly>
                        </div>
                        <div class="col-lg-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-1 nopadding">
                            <input type="text" class="form-control" ng-model="CurincperTravelAllowance" readonly>
                        </div>
                        <div class="col-lg-2">
                            <label class="col-form-label">Other
                                Deductions</label>
                        ...
                        <div class="col-lg-1 nopadding">
                            <input type="text" class="form-control" ng-model="CurincperOtherDeductions" readonly>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-1 nopadding">
                            <input type="text" class="form-control" ng-model="CurMottakehomewithouttax" readonly>
                        </div>
                        <div class="col-lg-1 nopadding">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <button class="btn btn-sm btn-rounded btn-success" ng-click=""  data-toggle="modal"   data-target="#ModalCenterApprovedFitment">
                                Approved</button>
                            <button class="btn btn-sm btn-rounded btn-danger" ng-click=""  data-toggle="modal"   data-target="#ModalCenterRejectedFitment">
                                Rejected</button>
                        </div>
                    </div>
...
<table class="fit-table-new mt-2">
    <tbody>
        ...
        <tr>
            ...
            <td><input type="text" class="form-control" ng-model="CurAnnuaSpecialAllowance" readonly></td>
            <td><input type="text" class="form-control" ng-model="CurincperSpecialAllowance" readonly></td>
            ...
            <td><input type="text" class="form-control" ng-model="CurincperTotalAllowance" readonly></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" class="form-control" ng-model="CurAnnuaEstimatedBonous" readonly></td>
            <td><input type="text" class="form-control" ng-model="CurincperEstimatedBonous" readonly></td>
        ...
        <tr>
            ...
            <td><input type="text" class="form-control" ng-model="CurAnnuaOtherDeductions" readonly></td>
            <td><input type="text" class="form-control" ng-model="CurincperOtherDeductions" readonly></td>
        </tr>
        <tr>
            <td>Travel Allowance</td>
            <td><input type="text" class="form-control" ng-model="CurMotTravelAllowance" readonly></td>
            <td><input type="text" class="form-control" ng-model="CurAnnuaTravelAllowance" readonly></td>
            <td><input type="text" class="form-control" ng-model="CurincperTravelAllowance" readonly></td>
            <td>&emsp;Take Home</td>
            <td><input type="text" class="form-control" ng-model="CurMottakehomewithouttax" readonly></td>
            <td><input type="text" class="form-control" ng-model="CurAnnuatakehomewithouttax" autocomplete="off"
readonly></td>
...
autocomplete="off" readonly></td>
        ...
        <tr>
            ...
            <td><input type="text" class="form-control" ng-model="CurincperDeductionTotal" readonly></td>
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td colspan="3" align="right"><button class="btn btn-sm btn-rounded btn-success mt-2" ng-click="" data-toggle="modal"
                            data-target="#ModalCenterApprovedFitment">Approve</button>
                            &nbsp;<button class="btn btn-sm btn-rounded btn-danger mt-2" ng-click="" data-toggle="modal"
                            data-target="#ModalCenterRejectedFitment">
                            Reject</button></td>
        </tr>
        ...
        <div class="modal fade" id="ModalCenterRejectedFitment" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-danger" role="alert">
                            If the status is Rejected , the candidate wil be rejected. It does not goes to next level.
...
<div class="table-responsive">
    ...
    <tbody>
        ...
        <tr>
         ...
         <td colspan="7" class="table-head"><br/>Other Components</td>
        <tr>
            <td>Est.CTC</td>
            <td><input type="text" class="form-control" ng-model="CurMotCTC" readonly></td>
            <td><input type="text" class="form-control" ng-model="CurAnnuaCTC" readonly></td>
            <td><input type="text" class="form-control" ng-model="CurincperCTC" readonly></td>
            <td>&emsp;Deductions</td>
            <td></td>
            <td></td>
            <td></td>
        </tr>
