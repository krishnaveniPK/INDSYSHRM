...
<head>
    ...
    <title>HR Interview Details</title>
...
<body>
    <div class="dashboard-wrapper" ng-App="MyApp" ng-controller="HRMApiController">
        <div class="container ">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-12 mx-15">
                            ...
                            <textarea type="text" class="form-control " ng-model="HRinterviewnotes"
            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-6 ">
                    <div class="text-right"> <button class="btn btn-sm btn-rounded btn-danger"
                            ng-click="UpdatedHRRejected()"><i class="fa fa-times" aria-hidden="true"></i>
                            Reject</button>
                        <button class="btn btn-sm btn-rounded btn-success" ng-click="UpdateHRApproved()"><i
                                class="fa fa-plus" aria-hidden="true"></i>
                            Approved & Build Fitment</button>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="card cardapi cardlabel" ng-show="btnshowfitment">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-right">
                                <button class="btn btn-sm btn-rounded btn-info" ng-click="FitOpen();">Add <i
                                        class="fa fa-plus" aria-hidden="true"></i></button>
                                <button ng-show="btnshowfitment" class="btn btn-sm  btn-rounded btn-success"
                                    ng-click="SendMailToDepartmentHead()">Send Approval <i class="fa fa-user"
                                        aria-hidden="true"></i>
                                </button>
                            </div>
