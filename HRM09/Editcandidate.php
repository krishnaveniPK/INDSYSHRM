...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper" ng-App="MyApp" ng-controller="HRM09Controller" style="overflow: hidden;">
            <div class="dashboard-content">

                <div id="myCarousel" class="carousel slide" data-interval="false" style="overflow= auto;">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="row">

                                <div class="col-md-12">
                                    <h5 class="text-green">Candidate Details</h5>
                                    <hr />
                                </div>
                                <div class="col-md-12">
                                        ...
                                        <table class="table table-bordered  table-sm ">
                                            ...
                                            <tbody>
                                                <tr dir-paginate="e in GetCandidateList02 |filter:searchCandidate|itemsPerPage:10 "
                                                    pagination-id="Candidategrid" current-page="currentPageCandidate">
                        ...
                        <div class="carousel-item">
                            <div class="">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <h5 class="text-green">Candidate Update</h5>
                                        <hr />
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <label class="col-form-label">Qualification<span
                                                        class="required">*</span></label>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" ng-model="Contactno"
                                                    ...
                                                    maxlength="10" ng-change="GetContactnounique(Contactno)" readonly>
                                        ...
                                        <div class="form-group text-right">
                                            ...
                                            <button class="btn btn-sm btn-rounded btn-primary"
                                                ng-click="FetchCandidate(Candidateid);"><i class="fa fa-refresh"></i>
                                                Refresh</button>
                                            <button class="btn btn-sm btn-rounded btn-info" ng-click="MovetoEmp();"><i
                                                    class="fa fa-arrows"></i>
                                                Move To Emp</button>
                                            <button class="btn btn-sm btn-rounded btn-warning" data-target="#myCarousel"
                                                data-slide-to="0"><i class="fa  fa-arrow-left"></i> Back</button>
                                        </div>
                                        ...
                                        <div class="tab-list">
                                            <ul class="nav nav-pills nav-fill">
                                                ...
                                                <li class="nav-item"><a data-toggle="tab" href="#menu10">Vaccination</a>
                                                </li>

                                                <li class="nav-item"><a data-toggle="tab" href="#menu3">Interview </a>
                                                </li>
                                                <li class="nav-item"><a data-toggle="tab" href="#menu4">Status</a></li>
                                                <li class="nav-item"><a data-toggle="tab" href="#menu9">Reporting</a>
                                                </li>
                                    ...
                                    <div class="col-md-12">
                                        <div class="tab-content">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="pagination">
                                                                    <dir-pagination-controls
                                                                        pagination-id="Educationgrid" max-size="3"
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-3"
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ng-model="PreviousDesignation" autocomplete="off"
                                                                    readonly>
                                                            ...
                                                            <div class="form-group col-md-3"
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ng-model="PreviousDepartment" autocomplete="off"
                                                                    readonly>
                                                            ...
                                                            <div class="form-group col-md-3"
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ng-model="Workingperiod" autocomplete="off"
                                                                    readonly>
                                                            ...
                                                            <div class="form-group col-md-3"
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ng-model="Releivingreason" autocomplete="off"
                                                                    readonly>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                <label class="col-form-label">Interview
                                                                    Time</label>
                                                                <input type="text" class="form-control"
                                                                    ng-model="Candidateinterviewtime"
                                            ...
                                            <div id="menu5" class="tab-pane fade">
                                                ...
                                                <div class="noshadow">
                                                    <h5 class="text-green mt-2 pl-0">Date Of Joining / Accepted Detail
                                                    </h5>
                                                    <hr />
                                                    <div class="">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-3">
                                                                <label class="col-form-label">Accepted
                                                                    CTC </label>
                                                                <input type="text" class="form-control"
                                                                    ng-model="CommitedCTC" autocomplete="off"
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="table-responsive">
                                                                ...
                                                                <div class="float-right mt-2">
                                                                    <div class="pagination ">
                                                                        <dir-pagination-controls
                                                                            pagination-id="Salarygrid" max-size="3"
                                                                            direction-links="true" boundary-links="true"
                                                                            class="pagination">
                                                                        </dir-pagination-controls>
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-3">
                                                                <label class="col-form-label">Current
                                                                    CTC</label>
                                                                <input type="text" class="form-control"
                                                                    ng-model="CurrentCTC" autocomplete="off"
                                                                    onkeypress="return Validate(event);">
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-3">
                                                                <label class="col-form-label">Expected
                                                                    CTC</label>
                                                                <input type="text" class="form-control"
                                                                    ng-model="ExpectedCTC" autocomplete="off"
                                                                    onkeypress="return Validate(event);">
                                                            </div>
                                            ...
                                            <div id="menu9" class="tab-pane fade">
                                                <div class="noshadow">
                                                    <h5 class="text-green mt-2 pl-0">Reporting Details and Designation
                                                    </h5>
                                                    <hr />
                                                    ...
                                                    <div class="">
                                                        <div class="row">
                                                            <div class="form-group col-md-2">
                                                                <label class="col-form-label">
                                                                    S.No </label>
                                                                <input type="text" class="form-control"
                                                                    id="Vaccinatedsno" ng-model="Vaccinatedsno"
                                                                    readonly>
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="Vaccinateddate" ng-model="Vaccinateddate"
                                                                    onfocus="(this.type='date')"
                                                                    onblur="(this.type='date')">
                                                            </div>
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="file" class="form-control"
                                                                        ng-model="clearinput" id="fileInput05"
                                                                        name=files[]
                                                                        accept="image/png, image/gif, image/jpeg,application/pdf">
                                                                    <div class="input-group-append">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="pagination">
                                                                    <dir-pagination-controls
                                                                        pagination-id="Vaccinationgrid" max-size="3"
                                                                        direction-links="true" boundary-links="true"
                                                                        class="pagination">
                                                                    </dir-pagination-controls>
                                            ...
                                            <div id="menu11" class="tab-pane fade">
                                                <div class="noshadow">
                                                    <h5 class="text-green mt-2 pl-0">Confirmation and Appointment Letter
                                                    </h5>
                                                    <hr />
                                                    <div class="">
                                                        <div class="row">
