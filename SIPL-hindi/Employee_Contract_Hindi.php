            ...
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <div class="card" style="margin: 30px">
                        <h5 class="card-header text-green">Employee Contract</h5>
...
<center>EMPLOYMENT CONTRACT<br/>
रोजगार समझोता <br/>
(BETWEEN EMPOLYER AND EMPLOYEE)<br/>
(नियोक्ता और कर्मचारी के बीच)<br/><br/><br/>
(EMPLOYER)<br/>
(नियोक्ता)
</center>
<div class="box">
...
<center>
<br/><br/><br/><br/>Vs<br/><br/><br/><br/>(EMPOLYEE)<br>(कर्मचारी)</center>
<div class="box">
<div class="box-data">
