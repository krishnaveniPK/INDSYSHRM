...
(function() {
    ...
    function g(a, f) { f = f || Error; return function() { var d = arguments[0],
                e;
            e = "[" + (a ? a + ":" : "") + d + "] http://errors.angularjs.org/1.7.8/" + (a ? a + "/" : "") + d; for (d = 1; d < arguments.length; d++) { e = e + (1 == d ? "?" : "&") + "p" + (d - 1) + "="; var q = encodeURIComponent,
                    b;
                b = arguments[d];
                b = "function" == typeof b ? b.toString().replace(/ \{[\s\S]*$/, "") : "undefined" == typeof b ? "undefined" : "string" != typeof b ? JSON.stringify(b) : b;
                e += q(b) } return new f(e) } }(function(a) {
        ...
        return f(a, "module", function() {
            ...
            return function(b, g, l) {
                ...
                return f(a, b, function() {
                    ...
                    function c(a, d, c) { c || (c = f); return function(f, e) { e && "function" === typeof e && (e.$$moduleName = b);
                            c.push([a, d, arguments]); return h } }
                    ...
                    var f = [],
                        ...
                        h = {
                            ...
                            _configBlocks: k,
                            _runBlocks: n,
                            info: function(a) { if ("undefined" !== typeof a) { if (null === a || "object" !== typeof a) throw e("aobj", "value");
                                    m = a; return this } return m },
                            requires: g,
                            name: b,
